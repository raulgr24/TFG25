...
INDEX_PATH = BASE_DIR / "index.html"                # ajusta si está en otro sitio
DATA_DIR  = BASE_DIR.parent / "Datos nuevos"        # .../TFG/Datos nuevos

# Memoria (precarga una vez)
GEOJSON_TEXT = {}        # nombre -> str GeoJSON en EPSG:4326
GEOJSON_TEXT_SIMPLE = {} # simplificado para pruebas

def to_wgs84(gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    # Si no tiene CRS, asumimos que ya está en 4326 (GeoJSON estándar)
    if gdf.crs is None:
        return gdf
    # Si tiene CRS y no es 4326, reproyectamos
...
if __name__ == "__main__":
    ...
    print("🔎 /api/health, /api/municipios, /api/centroides, /api/municipios_simple")
