...
def closest_destinations_cords(origin: str, destinations: list[str]) -> dict[str,dict[str,list[str]]]:
    """
...
def closest_destinations_cords_old(origin, destinations):
    """
    Lee el proyecto QGIS y devuelve un diccionario
    Para cada origen guarda sus coordenadas y las coordenadas de los destinos más cercanos
    """
